...
namespace game {
    namespace netvars {
        ...
        constexpr ptrdiff_t m_flHealthShotBoostExpirationTime = 0xA3C8;
        ...
        constexpr ptrdiff_t m_totalHitsOnServer = 0xA3A8;
    ...
    namespace signatures {
        ...
        constexpr ptrdiff_t find_hud_element = 0x2F2BE320;
